...
export default async function QuizReviewPage() {
  ...
  return <main style={{maxWidth:1100,margin:"auto",padding:"1rem"}}>
    ...
    <ReviewForm publicationEnabled={process.env.QUIZ_REVIEW_PUBLICATION_ENABLED==='true'} quizzes={[...new Map(catalog.questions.map(q=>[q.canvas_quiz_id,{id:q.canvas_quiz_id,step:q.step,stage:q.stage}])).values()]} />
    <p><a href="/">ホームへ戻る</a></p>
  </main>;
}
